...
동사는 의미를 가지고 있으며 변하지 않는 부분인 어간과 시제에 따라 변화하는 어미로 이루어져 있다.

어간의 끝은 어간모음인데, 어간모음에 따라 동사의 변화 양상이 다르다.

어간모음은 ‘ā, ē, ∅, ĭ, ī’가 있으며, 이에 따라 동사를 제1에서 제4변화로 분류한다. 어간모음이 없는 경우(∅), 즉 어간이 자음으로 끝나는 경우와 단음 i(ĭ)는 같은 제3변화로 분류한다.

어간은 현재형, 완료형, 분사형 3가지 형태가 있으며 각각 사용되는 시제가 다르다.

어미는 시제, 상(相), 법(法), 인칭, 수(數), 태(態)에 따라 변화하며, 현재완료형 일부를 제외하면 인칭, 수, 태는 종결어미에서 나타나고, 나머지는 선어말어미에서 나타난다.

변화 형태가 다른 불규칙 동사와, 변화 형태가 한정된 탈형 동사도 있다.

한편, 동사는 비한정적인 형태도 있다. 부정사, 분사, 동형용사, 동명사, 목적분사 등이 있으며, 변화하지 않는 일부 부정사와 두가지로 격변화만 하는 목적분사를 제외하고는 명사와 형용사와 마찬가지로 성, 수, 격에 따라 변화한다.
