...
(2) 3가지 형태 중에서 중복되는 것은 하나로 표기한다. 남성형과 여성형 주격 단수가 같은 경우도 있고, 남성, 여성, 중성 주격 단수가 모두 같은 형태인 경우도 있다.

이 경우 표제어가 2개 또는 1개가 되므로 명사와 혼동될 수도 있다. 그러나 명사에 없는 -is, -e 형태 등으로 명사와 다른 형태인 경우가 많다.

(3) 형용사 역시 명사와 마찬가지로 어간이 두 종류인 경우가 많다. 이 경우는 명사와 마찬가지로 남성 주격 단수와 소유격 단수를 표제어로 한다. 형태 또한 명사와 차이가 없다.

형용사에서 이렇게 소유격을 표기하는 경우는 주격 단수의 형태 3가지가 다 같은 경우인 경우가 많다. 일부 사전에서는 규칙변화 하는 경우에도 소유격으로 표기하기도 한다.
