...
출판된 번역은 아래와 같다. `위키백과 <https://en.wikipedia.org/w/index.php?title=Wheelock%27s_Latin&oldid=821043959>`_\에는 6판부터 한국어 번역이 출간된 것으로 서술되어 있으나, 그 이전 판도 번역판이 있다.
...
그러나 이러한 단점에도 불구하고 한국어로 번역된 것이기 때문에 영어판보다 학습에 더 용이한 면이 있다.
