...
이러한 유사성은 문법에서도 나타난다. 예를 들어 영어에서 전치사 of를 쓰는 경우는 라틴어 속격 쓰는 구문인 경우가 있고,(게르만어에서 유래한 경우도 있다.) 영어의 of가 가지고 있는 여러 의미가 라틴어 속격과 겹치기도 한다. 라틴어에서 여격을 쓰는 구문은 영어에서 for로, 라틴어에서 탈격을 쓰는 구문은 영어에서 from을 쓰는 것으로 나타나기도 한다.
...
독일어는 로망스어에 비해 라틴어와 거리가 멀다. 그러나 독일어 역시 어휘와 문법에서 라틴어의 영향을 대단히 많이 받았다.

심지어 현대 독일어 문법의 일부는 라틴어에 대한 반동으로 생겼을 정도이다. 예를 들어 독일어에서 K가 많이 쓰이는 이유는 라틴어에서 사용하지 않기 때문이다. 라틴어에서 K가 쓰이지 않는 이유는 문자와 발음 항목에서 다룬다.
