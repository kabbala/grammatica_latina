...
라틴어에서 동사의 어간 변화 양상은 어간모음 ā, ē, i, ī 4가지와 어간 끝이 자음이어서 어간모음이 없는 경우 5가지로 나누며, [*]_ 어간 끝이 자음인 경우와 어간모음이 단음 i인 경우는 변화 양상이 비슷해서 같은 제3변화로 분류한다.

.. [*] 어간모음이 o, u인 경우는 극소수여서 불규칙 변화로 분류한다.
