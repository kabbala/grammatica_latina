...
.. [*] 한국어에서와 달리 인도유럽어에서는 어간도 어간모음에 따라 변화하는 것으로 본다. 동사에는 보통 3가지 종류의 어간이 있는 것으로 보며, 사전표제어가 4개인 것은 이 3종류의 어간들을 나타내기 위한 것이다.
...
라틴어 동사는 변화에 따라 다음 3가지 종류의 어간을 가지고 있는 것으로 본다.

   1. 미완료형(imperfectum, 현재형)
   2. 완료형(perfectum, 과거형)
   3. 분사형(participium, 목적분사)
